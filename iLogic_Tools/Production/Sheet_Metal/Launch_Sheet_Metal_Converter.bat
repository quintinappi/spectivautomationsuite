...
cscript //nologo "Sheet_Metal_Converter.vbs"

echo.
echo Sheet metal conversion completed.

echo.
echo Enabling Thickness export parameter for all plates...
cscript //nologo "Enable_Thickness_Export_All.vbs"

echo.
echo Running UI automation to refresh iProperty displays...
cscript //nologo "UI_Automation_DocSettings.vbs"

echo.
echo Force precision update to re-evaluate all parameters...
cscript //nologo "Force_UI_DocSettings.vbs"
