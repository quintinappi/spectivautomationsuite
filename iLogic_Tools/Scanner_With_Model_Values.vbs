' Scanner with Model Values - Shows all parameters for non-plate parts without Length
            ...
            If Not seen.Exists(subdoc.FullFileName) Then
                ...
                If Not isPlate Then
                    ...
                    If Not hasLen Then
                        ...
                        ' List all user parameters and their model values
                        Err.Clear
                            ...
                            If params.Count > 0 Then
                                ...
                                For j = 1 To params.Count
                                    ...
                                    If Err.Number = 0 Then
                                        ...
                                        ' Get model value (internal value in base units)
                                        Err.Clear
                                ...
                                Next
                            Else
                                WScript.Echo "      (no user parameters)"
                            End If
                        Else
