...
Sub Main()
    ...
    ' Process each part with simple continue/stop
    Dim processedCount
    processedCount = 0
    ...
    LogMessage ""
    LogMessage "✓ SUCCESS! " & processedCount & " parts have been updated."
    LogMessage "✓ BOM precision has been refreshed for all processed plate parts."
    ...
    successMsg = successMsg & "Parts processed: " & processedCount & " of " & plateParts.Count & vbCrLf & vbCrLf
