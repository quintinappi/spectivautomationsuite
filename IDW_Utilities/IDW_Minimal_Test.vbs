...
Sub Main()
    ...
    logPath = fso.GetParentFolderName(WScript.ScriptFullName) & "\IDW_Minimal_Test.log"
    ...
    ' Ensure target sheet (next after source)
    ...
    msg = msg & "Target: " & targetSheet.Name & vbCrLf & vbCrLf
    msg = msg & "Assembly: " & assemblyDoc.DisplayName & vbCrLf
    msg = msg & "Parts found: " & partCount & vbCrLf
    msg = msg & "Views placed at 1:10: " & viewsPlaced & vbCrLf
...
Function PlacePartView(sheet, partPath, viewIndex)
    ...
    If Err.Number = 0 And Not baseView Is Nothing And viewsAfter > viewsBefore Then
        LogMessage "  SUCCESS at 1:10 (views: " & viewsBefore & " -> " & viewsAfter & ")"
    Else
