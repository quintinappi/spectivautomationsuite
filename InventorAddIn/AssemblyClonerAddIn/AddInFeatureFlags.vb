        ...
        Public Function DisabledMessage(ByVal toolDisplayName As String) As String
            Return toolDisplayName & " is temporarily hidden during migration to the Inventor Add-In." & vbCrLf & vbCrLf &
                   "Status: command exists but is not enabled yet." & vbCrLf &
                                 "Enabled right now: Clone Assembly, Assembly Renamer, Title Automation (IDW), Registry Management, Populate DWG REF tools, CREATE DXF FOR MODEL PLATES, Place parts from open Assembly, Create Sheet Parts List, Create GA Parts List (Top Level), Clean Up Unused Files, Length Parameter Exporter, Length2 Parameter Exporter, Thickness Parameter Exporter, Fix Non-Plate Parts, Fix Single Part Length2, Fix BOM Plate Dimensions, Apply Plate Desc/Stock Formula."
        End Function
